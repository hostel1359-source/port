...
export default function ProjectDoor({
  ...
  const doorMat = useMemo(() => new THREE.MeshStandardMaterial({ color: '#8B7355', roughness: 0.7 }), []);
  const handleMat = useMemo(() => new THREE.MeshStandardMaterial({ color: '#5c4a3a', roughness: 0.4, metalness: 0.3 }), []);
